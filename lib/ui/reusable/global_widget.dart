...
class GlobalWidget {
  ...
  Widget screenTabList({BuildContext context, int id, String title, IconData icon, String desc, StatefulWidget page}) {
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 4),
                    (desc == null) ? Wrap() : Text(desc, style: TextStyle(fontSize: 12, color: Colors.grey[700])),
          ...
          child: Container(
            ...
            child: Row(
              children: [
                ...
                SizedBox(width: 24),
                Expanded(
                  child: Text(title, style: TextStyle(fontSize: 16, color: BLACK55, fontWeight: FontWeight.w500)),
                ),
  ...
  Widget createDetailWidget({String title, String desc}) {
    return Column(
      ...
      children: [
        Container(
          child: Text(title, style: TextStyle(fontSize: 18, color: BLACK21, fontWeight: FontWeight.w500)),
        ),
        Container(
          margin: EdgeInsets.only(top: 8),
          child: Container(
            child: Text(desc, style: TextStyle(fontSize: 15, color: BLACK77, letterSpacing: 0.5)),
          ),
        ),
        Container(
          margin: EdgeInsets.only(top: 24, bottom: 8),
          child: Text('Example', style: TextStyle(fontSize: 18, color: BLACK21, fontWeight: FontWeight.w500)),
        ),
      ],
    );
  }
  ...
  Widget createDefaultLabel(context) {
    return Container(
      ...
      decoration: BoxDecoration(color: SOFT_BLUE, borderRadius: BorderRadius.circular(2)),
      child: Row(
        children: [
