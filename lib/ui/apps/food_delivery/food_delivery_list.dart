  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: ListView(
          ...
          children: [
            Container(
              child: Text('Food Delivery - Multi Merchants', style: TextStyle(fontSize: 18, color: BLACK21, fontWeight: FontWeight.w500)),
            ),
            Container(
              ...
              child: Row(
                children: [
                  Flexible(
                      flex: 5,
                      child: Container(
                        child: Text('Food delivery apps used for food delivery services.', style: TextStyle(fontSize: 15, color: BLACK77, letterSpacing: 0.5)),
                      )),
                  Flexible(flex: 2, child: Container(alignment: Alignment.center, child: Icon(Icons.restaurant, size: 50, color: SOFT_BLUE)))
                ],
              ),
            ),
            Container(
              margin: EdgeInsets.only(top: 48),
              child: Text('Screen List', style: TextStyle(fontSize: 18, color: BLACK21, fontWeight: FontWeight.w500)),
            ),
            SizedBox(height: 18),
